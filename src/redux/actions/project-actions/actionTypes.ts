enum ProjectActionTypes {
    ...
    ALTER_PROJECTS_COLLECTION = 'ALTER_PROJECTS_COLLECTION',
    SET_SELECTED_PROJECT = 'SET_SELECTED_PROJECT',
    EDIT_PROJECT_TEAM = 'EDIT_PROJECT_TEAM',
    EDIT_PROJECT_TEAM_SUCCESS = 'EDIT_PROJECT_TEAM_SUCCESS',
    EDIT_PROJECT_TEAM_FAIL = 'EDIT_PROJECT_TEAM_FAIL',
